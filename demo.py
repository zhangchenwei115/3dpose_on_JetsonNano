...
if __name__ == '__main__':
    ...
    #parser.add_argument('--video', help='Optional. Path to video file or camera id.', default='')
    ...
    #is_video = False
    frame_provider = VideoReader('nvarguscamerasrc ! video/x-raw(memory:NVMM), width=1280, height=720,format=(string)NV12, framerate=(fraction)60/1 ! nvvidconv ! video/x-raw, format=(string)BGRx ! videoconvert ! video/x-raw, format=(string)BGR ! appsink')
    is_video = True
